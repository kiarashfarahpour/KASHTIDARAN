                                ...
                                <div class="tab-content">
                                    <div id="tab_general" class="tab-pane active">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <textarea name="content" id="content" class="form-control tinymce" dir="auto" rows="25">{{ old('content', $page->content) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="css" class="control-label col-md-3 col-sm-3 col-xs-12">css</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <textarea name="css" id="css" class="form-control" dir="auto" rows="20">{{ old('css', $page->css) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="js" class="control-label col-md-3 col-sm-3 col-xs-12">js</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <textarea name="js" id="js" class="form-control" dir="auto" rows="20">{{ old('js', $page->js) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="tab_information" class="tab-pane">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select name="form_id" id="form_id">
                                                    ...
                                                    @foreach($forms as $id => $name)
                                                        <option value="{{ $id }}"{{ $id == old('form_id', $page->form_id) ? 'selected' : '' }}>{{ $name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="file" name="image" id="image" value="{{ old('image') }}" class="dropify" @if($page->image_id) data-default-file="{{ $page->image->name }}" @endif >
                                            </div>
                                        </div>
                                        <div class="form-group">
