                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
                                <a href="{{ route('admin.inputs.index', $input->form->id) }}">فیلدها
                    ...
                    <div class="x_content">
                        <div class="nav-tabs-custom no-shadow">
                            ...
                            <br>
                            <form action="{{ route('admin.inputs.update', $input->id) }}" method="post" data-parsley-validate="" class="form-horizontal form-label-left">
                                @csrf
                                @method('patch')
                                    ...
                                    <div id="tab_general" class="tab-pane active">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" name="label" id="label" class="form-control" value="{{ old('label', $input->label) }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select name="type" id="type" class="form-control">
                                                    <option value="text"{{ old('type', $input->type) == 'text' ? ' selected' : '' }}>متن</option>
                                                    <option value="select"{{ old('type', $input->type) == 'select' ? ' selected' : '' }}>انتخابی</option>
                                                    <option value="checkbox"{{ old('type', $input->type) == 'checkbox' ? ' selected' : '' }}>چکباکس</option>
                                                    <option value="textarea"{{ old('type', $input->type) == 'textarea' ? ' selected' : '' }}>تکست</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" name="placeholder" id="placeholder" class="form-control" value="{{ old('placeholder', $input->placeholder) }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="sort_order" class="control-label col-md-3 col-sm-3 col-xs-12">ترتیب</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="number" name="sort_order" id="sort_order" class="form-control" value="{{ old('sort_order', $input->sort_order) }}" min="0">
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    @foreach($input->rules as $key => $rule)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="values[]" class="form-control" dir="ltr" value="{{ $input->values[$key] }}">
                                                            </td>
                                                            <td>
