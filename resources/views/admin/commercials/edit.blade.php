...
@section('scripts')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDI53jW8IdXP6UsEwbrsY3M4mElt014xec&callback=loadMap&language=fa"></script>
    <script>
        function loadMap() {
            var mapOptions = {
                                ...
                                <div id="tab_gallery" class="tab-pane">
                                    ...
                                    @foreach($commercial->images as $image)
                                        <div class="col-md-3 col-sm-6 col-xs-12 imageWrapper">
                                            ...
                                            <input type="radio" name="default_image" value="{{ $image->id }}" id="default_image{{ $image->id }}">
                                            <label for="default_image{{ $image->id }}">تصویر اصلی</label>
                                        </div>
                                    @endforeach
