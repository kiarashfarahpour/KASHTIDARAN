...
Route::prefix('admin')->name('admin.')->namespace('Admin')->middleware(['auth', /*'twoFactor'*/])->group(function () {
    ...
    Route::resource('items', 'ItemController')->only(['edit', 'update', 'destroy']);
    Route::resource('weather/{weather}/items', 'ItemController')->only(['index', 'create', 'store']);
    ...
    Route::patch('blog/{id}', 'ArticleController@update')->name('blog.update');
    Route::resource('pages', 'PageController')->except('show');
    Route::resource('blog', 'ArticleController')->except(['show', 'update']);
    ...
    Route::post('forms/{form}/ajax', 'InputController@ajax')->name('inputs.ajax');
    Route::resource('forms/{form}/inputs', 'FieldController')->only(['index', 'create', 'store']);
    Route::post('forms/ajax', 'FormController@ajax')->name('forms.ajax');
    Route::resource('inputs', 'InputController')->only(['edit', 'update', 'destroy']);
...
Route::name('frontend.')->namespace('Frontend')->group(function () {
    ...
    Route::post('iam/{commercial}', 'CommercialController@iam')->name('commercials.iam');
    Route::get('/', 'AppController@index')->name('app.index');
    /*Route::prefix('shop')->name('shop.')->namespace('Shop')->group(function() {
    ...
    Route::get('p/{province}', 'CitiesController@province')->name('provinces.show');
    Route::get('{city}/new', 'CommercialController@create')->name('commercials.new');
    //Route::get('{city}/{category}/new', 'CommercialController@create')->name('commercials.create');
    Route::post('{city}/', 'CommercialController@store')->name('commercials.store');
