...
class CityController extends Controller
{
    ...
    public function store(CityRequest $request)
    {
        ...
        City::create($request->only('name', 'title', 'province_id', 'latitude', 'longitude', 'meta_keywords', 'meta_description', 'slug'));
    ...
    {
        $request->merge(['meta_keywords' => dash2comma($request->meta_keywords)]);
        $city->update($request->only('name', 'title', 'province_id', 'latitude', 'longitude', 'meta_keywords', 'meta_description', 'slug'));
