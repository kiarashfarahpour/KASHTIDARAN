...
@section('title', ($city->title ?? 'تمام شهرها') . ' - ' . $category->name)
@section('styles')
    <style>
        .ajax-load{
            background: #e1e1e1;
...
@endsection
@section('seo')
    <meta name="keywords" content="{{ ($city->title ?? 'تمام شهرها') . ',' . $category->meta_keywords }}">
    <meta name="description" content="{{ ($city->title ?? 'تمام شهرها') . ' - ' . $category->meta_description }}">
    <meta name="og:title" content="{{ ($city->title ?? 'تمام شهرها') . ' - ' . $category->name }}">
    <meta name="og:description" content="{{ ($city->title ?? 'تمام شهرها') . ' - ' . $category->meta_description }}">
@endsection
@section('content')
<!-- product list -->
