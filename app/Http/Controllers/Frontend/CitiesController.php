...
class CitiesController extends Controller
{
    ...
    /**
     * Display list of commercials inside a province.
     * @param  \Illuminate\Http\Request  $request
     * @param  string  $code
    ...
    {
        $citiesId           = $province->cities()->pluck('id')->toArray();
        $commercialsQuery   = Commercial::with([
            'district',
            'fields' => function ($query) {
                $query->price();
        ...
        return view('frontend.cities.province', compact('commercials', 'province'));
    }
