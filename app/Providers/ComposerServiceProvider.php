...
use App\Http\ViewComposers\PendingCommercialsComposer;
...
class ComposerServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer('admin.layouts.header', PendingCommercialsComposer::class);

        view()->composer('frontend.layouts.header', CitiesComposer::class);
        view()->composer('frontend.layouts.blank', CitiesComposer::class);
        view()->composer('frontend.layouts.header', CityComposer::class);
        view()->composer('frontend.layouts.header', GroupsComposer::class);
        view()->composer('frontend.layouts.header', CategoriesComposer::class);
