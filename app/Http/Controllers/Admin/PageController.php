...
class PageController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.pages.create', compact('forms'));
    }
    ...
    public function store(PageRequest $request)
    {
        ...
        $page = Page::create($request->only(['user_id', 'title', 'form_id', 'slug', 'image_id', 'content', 'css', 'js', 'meta_keywords', 'meta_description', 'status']));
    ...
    {
        $forms = Form::pluck('name', 'id')->toArray();
        return view('admin.pages.edit', compact('page', 'forms'));
    }
    ...
    public function update(PageRequest $request, Page $page)
    {
        ...
        $page->update($request->only(['title', 'slug', 'form_id', 'image_id', 'content', 'css', 'js', 'meta_keywords', 'meta_description', 'status']));
