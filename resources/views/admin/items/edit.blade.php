    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="{{ route('admin.items.update', $item->id) }}" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left">
                        @csrf
                        @method('patch')
                        <div class="form-group">
                            <label for="title" class="control-label col-md-3 col-sm-3 col-xs-12">عنوان *</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="title" id="title" class="form-control" value="{{ old('title', $item->title) }}" autocomplete="off" placeholder="هواشناسی استان خوزستان">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="url" name="link" id="link" class="form-control" value="{{ old('link', $item->link) }}" dir="ltr" autocomplete="off" placeholder="http://hormozgan.ir/weather">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="suffix" id="suffix" class="form-control" value="{{ old('suffix', $item->suffix) }}" autocomplete="off" placeholder="pdf">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="url" name="site" id="site" class="form-control" value="{{ old('site', $item->site) }}" dir="ltr" autocomplete="off" placeholder="http://khozestan.ir">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" name="sort_order" id="sort_order" class="form-control" value="{{ old('sort_order', $item->sort_order) }}" min="0" max="999" autocomplete="off" placeholder="0">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="method" id="method" class="form-control" dir="rtl" autocomplete="off">
                                    <option value="0"{{ old('method', $item->method) == 0 ? ' selected' : '' }}>ثابت و بدون آپدیت</option>
                                    <option value="1"{{ old('method', $item->method) == 1 ? ' selected' : '' }}>دریافت فایل از لینک مستقیم</option>
                                    <option value="2"{{ old('method', $item->method) == 2 ? ' selected' : '' }}>دریافت فایل از لینک داخل المان</option>
                                    <option value="3"{{ old('method', $item->method) == 3 ? ' selected' : '' }}>دریافت محتوای یک المان</option>
                                    <option value="4"{{ old('method', $item->method) == 4 ? ' selected' : '' }}>دریافت فایل از طریق لینک داینامیک</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="element" id="element" class="form-control" value="{{ old('element', $item->element) }}" dir="rtl" autocomplete="off" placeholder='id="contentDiv"'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" name="duration" id="duration" class="form-control" value="{{ old('duration', $item->duration) }}" dir="rtl" autocomplete="off" placeholder="1800">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="url" name="last_link" id="last_link" class="form-control" value="{{ old('last_link', $item->last_link) }}" dir="rtl" autocomplete="off" placeholder="http://sistan.ir/weather">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="last_link_element" id="last_link_element" class="form-control" value="{{ old('last_link_element', $item->last_link_element) }}" dir="rtl" autocomplete="off" placeholder='id="contentDiv"'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea name="content" id="content" class="form-control tinymce">{{ old('content', $item->content) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="file" name="image" id="image" class="dropify" @if($item->image_id) data-default-file="{{ asset($item->image->name) }}" @endif>
                            </div>
                        </div>
